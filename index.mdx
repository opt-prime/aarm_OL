...
<Note>
  **Current version: v1** — Initial public release of the AARM specification. The specification is open and will evolve as the agent ecosystem matures. [Contribute on GitHub](https://github.com/aarm-dev/docs).
</Note>
